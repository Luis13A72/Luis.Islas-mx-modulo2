import pygame
from dino_runner.utils.constants import RUNNING, JUMPING #Se importa la constante a usar
class Dinosaur:
    ...
    def update(self, user_input):   #Siempre ddebe estar para cuando se agregue un objeto al juego
        ...
        elif not self.dino_jump:    #Si no está saltando entonces está corriendo
    ...
    def draw(self, screen):     #Siempre ddebe estar para cuando se agregue un objeto al juego, donde lo dibujara
